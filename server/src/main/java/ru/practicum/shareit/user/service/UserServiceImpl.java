...
public class UserServiceImpl implements UserService {
    ...
    public UserDto updateUser(Long userId, UserDto userDto) {
        ...
        if (userDto.getName() != null) {
            userRepository.updateUserName(user.getName(), userId);
            user.setName(userDto.getName());
        }
        if (userDto.getEmail() != null) {
            if (!checkEmail(userDto, userId)) {
                userRepository.updateUserEmail(user.getEmail(), userId);
    ...
    private boolean checkEmail(UserDto userDto, Long userId) {
