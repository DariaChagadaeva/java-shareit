...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> addBooking(Long userId, BookingRequest bookingRequest) {
    ...
    public ResponseEntity<Object> getAllBookerItemsBooking(long userId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
