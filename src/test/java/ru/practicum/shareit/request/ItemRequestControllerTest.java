...
class ItemRequestControllerTest {
    ...
    @SneakyThrows
    @Test
    void addItemRequest_whenItemRequestIsNotValid_thenReturnBadRequest() {
        ItemRequestDto it = new ItemRequestDto(null);
        ...
        verify(itemRequestService, never()).addItemRequest(1L, it);
    }
